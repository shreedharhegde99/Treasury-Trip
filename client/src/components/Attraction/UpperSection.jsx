    ...
    return (
        <>
           <Box bg='#F5F5F5' w='100%' h="250px">           
                 ...
                 <Flex w="70%" style={{marginTop:"27px",marginLeft:"20%",marginRight:"100%"}}>
                    <InputGroup>
                    <InputLeftElement 
           ...
           <div style={{borderRadius:"10px",border:"1px solid lightgrey",width:"80%",height:"80px",margin:"auto",marginTop:"40px"}}> 
